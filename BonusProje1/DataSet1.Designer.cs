...
namespace BonusProje1.DataSet1TableAdapters {
    ...
    public partial class TBL_DERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int DesrSil(byte Original_DERSID) {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBL_OGRENCİLER.OGRID, TBL_OGRENCİLER.OGRAD, TBL_OGRENCİLER.OGRSOYAD, TBL_K" +
                "ULUPLER.KULUPAD, TBL_OGRENCİLER.OGRCINSIYET\r\nFROM     TBL_OGRENCİLER INNER JOIN\r" +
                "\n                  TBL_KULUPLER ON TBL_OGRENCİLER.OGRKULUP = TBL_KULUPLER.KULUPI" +
                "D";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT TBL_OGRENCİLER.OGRID, TBL_OGRENCİLER.OGRAD, TBL_OGRENCİLER.OGRSOYAD, TBL_KULUPLER.KULUPAD, TBL_OGRENCİLER.OGRCINSIYET
FROM     TBL_OGRENCİLER INNER JOIN
                  TBL_KULUPLER ON TBL_OGRENCİLER.OGRKULUP = TBL_KULUPLER.KULUPID
WHERE  (TBL_OGRENCİLER.OGrad = @OGRad)";
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE TBL_OGRENCİLER\r\nSET          OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRKULU" +
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "INSERT INTO TBL_OGRENCİLER\r\n                  (OGRAD, OGRSOYAD ,OGRKULUP, OGRCINS" +
